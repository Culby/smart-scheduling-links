...
* Examples for this Profile: [Slot/ExampleSlot](Slot-ExampleSlot.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/fhir.ig|current/StructureDefinition/smart-scheduling-slot)
...
Other representations of profile: [CSV](StructureDefinition-smart-scheduling-slot.csv), [Excel](StructureDefinition-smart-scheduling-slot.xlsx), [Schematron](StructureDefinition-smart-scheduling-slot.sch) 
...
```json
{
  ...
  "url" : "https://smart-scheduling-links.org/StructureDefinition/smart-scheduling-slot",
  "version" : "0.1.0",
  "name" : "SmartSchedulingSlot",
  "title" : "Slot",
  "status" : "draft",
