...
| | |
| :--- | :--- |
| *Official URL*:https://smart-scheduling-links.org/StructureDefinition/smart-scheduling-practitioner | *Version*:0.1.0 |
| Draft as of 2026-03-05 | *Computable Name*:SmartSchedulingPractitioner |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/fhir.ig|current/StructureDefinition/smart-scheduling-practitioner)
...
Other representations of profile: [CSV](StructureDefinition-smart-scheduling-practitioner.csv), [Excel](StructureDefinition-smart-scheduling-practitioner.xlsx), [Schematron](StructureDefinition-smart-scheduling-practitioner.sch) 
...
```json
{
  ...
  "url" : "https://smart-scheduling-links.org/StructureDefinition/smart-scheduling-practitioner",
  "version" : "0.1.0",
