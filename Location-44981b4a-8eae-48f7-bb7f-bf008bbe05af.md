...
Profile: [Location](StructureDefinition-smart-scheduling-location.md)
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://smart-scheduling-links.org/StructureDefinition/smart-scheduling-location"]
  },
  "identifier" : [{
